...
ncE.icon = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/NetworkControllerI.png"
ncE.icon_size = 128
ncE.order = "zzz"
...
ncE.graphics_set = {
    animation = {
        north = {
            layers = {{
                filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/NetworkControllerE.png",
                priority = "high",
                width = 600,
                height = 600,
                frame_count = 120,
                ...
                filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/NetworkControllerS.png",
                priority = "high",
                width = 600,
                height = 600,
                frame_count = 1,
...
ncE.graphics_set.idle_animation = ncE.graphics_set.animation
ncE.always_draw_idle_animation = true
ncE.match_animation_speed_to_activity = false
ncE.graphics_set.animation = nil
...
ncAn.filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/NetworkControllerE.png"
ncAn.width = 600
ncAn.height = 600
ncAn.line_length = 12
