...
daE.icon = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerI.png"
daE.icon_size = 64
...
daE.picture =
    {
      ...
      {
        {
            filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerE.png",
            priority = "extra-high",
            width = 600,
            height = 600,
            shift = {0,-0.1},
        ...
        {
            filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerS.png",
            priority = "high",
            width = 600,
            height = 600,
            shift = {0,-0.1},
...
daI.icon = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerI.png"
daI.icon_size = 128
...
daR.ingredients =
    ...
    daR.results = 
  {
    {type="item", name="DataAssembler", amount=1}
  }
data:extend{daR}
...
daT.type = "technology"
daT.icon = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerI.png"
daT.icon_size = 128
daT.unit = {
	count=16,
	time=60,
...
daS1.filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerSprite1.png"
daS1.size = 600
daS1.shift = {0,-0.1}
daS1.scale = 1/6
data:extend{daS1}
...
daS2.filename = "__Mobile_Factory_Graphics_zoms__/graphics/matter-serialization/DataAssemblerSprite2.png"
daS2.size = 600
daS2.shift = {0,-0.1}
daS2.scale = 1/6
data:extend{daS2}