...
rcE.icon = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorI.png"
rcE.icon_size = 256
...
rcE.picture = {
	layers = {
		{
			filename = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorE.png",
			width = 600,
			height = 600,
			frames = 1,
			scale = 1/600*33*6
		...
		{
			filename = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorS.png",
			width = 600,
			height = 600,
			frames = 1,
			scale = 1/600*33*6,
...
rctE.icon = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorI.png"
rctE.icon_size = 256
...
rctE.graphics_set = {
    animation = {filename="__Mobile_Factory_Graphics_zoms__/graphics/Alpha.png", size=1}
}
rctE.idle_animation = {filename="__Mobile_Factory_Graphics_zoms__/graphics/Alpha.png", size=1}
...
rcI.icon = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorI.png"
rcI.icon_size = 256
...
rcT.type = "technology"
rcT.icon = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorI.png"
rcT.icon_size = 256
rcT.unit = {
	count=15,
	time=60,
...
rcAn.type = "animation"
rcAn.frame_count = 60
rcAn.filename = "__Mobile_Factory_Graphics_zoms__/graphics/entity/ResourcesCollectorAn.png"
rcAn.size = 600
rcAn.line_length = 10
