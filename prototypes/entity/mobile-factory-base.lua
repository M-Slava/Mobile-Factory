...
mf.animation =
{
	priority = "low",
			...
			{
				{
				filename = "__Mobile_Factory_Graphics_zoms__/graphics/mobile-factory/mobile-factory.png",
				width_in_frames = 10,
				height_in_frames = 8
				}
			}
...
mfI.icon = "__Mobile_Factory_Graphics_zoms__/graphics/mobile-factory/tank.png"
mfI.icon_size = 256
...
mfT.type = "technology"
mfT.icon = "__Mobile_Factory_Graphics_zoms__/graphics/mobile-factory/tank.png"
mfT.icon_size = 256
mfT.unit = {
    count = 250,
    time = 1,
...
mfT.effects = {{
    type = "unlock-recipe",
    recipe = "MobileFactory"
}, {
    type = "unlock-recipe",
    recipe = "DimensionalTile"
}}
data:extend{mfT}
