...
-- Mobile Factory GT --
createNewMF("GTMobileFactory", {1,0.2,0.2}, 0.7, "b", "__Mobile_Factory_Graphics_zoms__/graphics/mobile-factory/QuickMF.png")
...
-- Hovering Factory --
createNewMF("HMobileFactory", {49,92,255}, 0.9, "c",  "__Mobile_Factory_Graphics_zoms__/graphics/mobile-factory/HMF.png")
